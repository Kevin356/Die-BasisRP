...
switch (_var) do
{
	...
	case "life_inv_schwarz": {"Schwarz Gebrannter"};
    case "life_inv_roggen": {"Roggen"};
	case "life_inv_hefe": {"Hefe"};
	case "life_inv_hopfen": {"Hopfen"};
	case "life_inv_trauben": {"Trauben"};
    case "life_inv_henrap": {"Hühnchenfleisch"};
	case "life_inv_roosterrap": {"Hähnchenfleisch"};
	case "life_inv_goatrap": {"Ziegenfleisch"};
	case "life_inv_sheeprap": {"Schaafsfleisch"};
	case "life_inv_rabbitrap": {"Hasenfleisch"};
    case "life_inv_henraw": {"Hühnchenfleisch unverarbeitet"};
	case "life_inv_roosterraw": {"Hähnchenfleisch unverarbeitet"};
	case "life_inv_goatraw": {"Ziegenfleisch unverarbeitet"};
	case "life_inv_sheepraw": {"Schaafsfleisch unverarbeitet"};
	case "life_inv_rabbitraw": {"Hasenfleisch unverarbeitet"};
    case "life_inv_ring": {"Gold Ring"};
    case "life_inv_seide": {"Seidenstoff"};
    case "life_inv_kunstoff": {"Kunstoff"};
    case "life_inv_reifenu": {"Komplettreifen"};
	case "life_inv_reifenp": {"Gummi"};
    case "life_inv_holzu": {"Stöcke"};
	case "life_inv_holzp": {"Möbelstücke"};
    case "life_inv_baumwolleu": {"Baumwollen Stücke"};
	case "life_inv_baumwollep": {"Baumwolle"};
    case "life_inv_silberu": {"Rohsilber"};
	case "life_inv_silberp": {"Silber"};
    case "life_inv_goldu": {"Golderz"};
	case "life_inv_goldp": {"Gold"};
	...
	case "license_civ_bier": {"Bierverarbeitungs Lizenz"};
	case "license_civ_huhn": {"Hühnerfleisch Lizenz"};
	case "license_civ_hahn": {"Hähnchenfleisch Lizenz"};
	case "license_civ_ziege": {"Ziegenfleisch Lizenz"};
	case "license_civ_schaaf": {"Schaafsfleisch Lizenz"};
	case "license_civ_hasen": {"Hasenfleisch Lizenz"};
	case "license_civ_ring": {"Gold Ring Lizenz"};
	case "license_civ_seide": {"Seidenverarbeiter Lizenz"};
	case "license_civ_kunstoff": {"Kunstoff Lizenz"};
	case "license_civ_reifen": {"Gummi Lizenz"};
	case "license_civ_holz": {"Schreiner Lizenz"};
	case "license_civ_baumwolle": {"Baumwollen Lizenz"};
	...
	case "license_cop_sek": {"SEK Lizenz"};
