...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
		    ...
		    case "huhn": {_var = "license_civ_huhn"};
			case "hahn": {_var = "license_civ_hahn"};
			case "ziege": {_var = "license_civ_ziege"};
			case "schaaf": {_var = "license_civ_schaaf"};
			case "hasen": {_var = "license_civ_hasen"};
		    case "ring": {_var = "license_civ_ring"};
		    case "seide": {_var = "license_civ_seide"};
		    case "kunstoff": {_var = "license_civ_kunstoff"};
		    case "reifen": {_var = "license_civ_reifen"};
	...
	case 1:
	{
		switch (_type) do
		{
		    ...
		    case "license_civ_huhn": {_var = "huhn"};
			case "license_civ_hahn": {_var = "hahn"};
			case "license_civ_ziege": {_var = "ziege"};
			case "license_civ_schaaf": {_var = "schaaf"};
			case "license_civ_hasen": {_var = "hasen"};
		    case "license_civ_ring": {_var = "ring"};
		    case "license_civ_seide": {_var = "seide"};
		    case "license_civ_kunstoff": {_var = "kunstoff"};
		    case "license_civ_reifen": {_var = "reifen"};
			...
			case "license_cop_sek": {_var = "sek"}; //SEK License cost
