...
switch (_className) do
{
	...
	case "O_MRAP_02_F": {75};
	case "I_MRAP_03_F": {125};
	case "B_Heli_Light_01_F": {100};
	case "O_Heli_Light_02_unarmed_F": {350};
	case "I_Heli_Transport_02_F": {1000};
	case "B_Heli_Transport_01_F": {1000};
	case "B_Heli_Transport_03_unarmed_F": {2000};
	case "O_Heli_Transport_04_box_black_F": {1500};
	case "C_Rubberboat": {40};
	case "O_Boat_Armed_01_hmg_F": {75};
	case "B_G_Boat_Transport_01_F": {45};
	case "B_Boat_Transport_01_F": {100};
	case "O_Heli_Light_02_F": {350};
