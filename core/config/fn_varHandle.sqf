...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
		    case "arteu": {"life_inv_arteu"};
			case "artep": {"life_inv_artep"};
		    case "bier": {"life_inv_bier"};
			case "wodka": {"life_inv_wodka"};
			case "wein": {"life_inv_wein"};
			case "schwarz": {"life_inv_schwarz"};
		    case "roggen": {"life_inv_roggen"};
			case "hefe": {"life_inv_hefe"};
			case "hopfen": {"life_inv_hopfen"};
			case "trauben": {"life_inv_trauben"};
		    case "henrap": {"life_inv_henrap"};
			case "roosterrap": {"life_inv_roosterrap"};
			case "goatrap": {"life_inv_goatrap"};
			case "sheeprap": {"life_inv_sheeprap"};
			case "rabbitrap": {"life_inv_rabbitrap"};
		    ...
		    case "ring": {"life_inv_ring"};
		    case "seide": {"life_inv_seide"};
		    case "kunstoff": {"life_inv_kunstoff"};
		    case "reifenu": {"life_inv_reifenu"};
			case "reifenp": {"life_inv_reifenp"};
		    case "holzu": {"life_inv_holzu"};
			case "holzp": {"life_inv_holzp"};
			case "oilu": {"life_inv_oilu"};
			case "oilp": {"life_inv_oilp"};
			case "baumwolleu": {"life_inv_baumwolleu"};
	...
	case 1:
	{
		switch (_var) do
		{
		    case "life_inv_arteu": {"arteu"};
			case "life_inv_artep": {"artep"};
		    case "life_inv_bier": {"bier"};
			case "life_inv_wodka": {"wodka"};
			case "life_inv_wein": {"wein"};
			case "life_inv_schwarz": {"schwarz"};
		    case "life_inv_roggen": {"roggen"};
			case "life_inv_hefe": {"hefe"};
			case "life_inv_hopfen": {"hopfen"};
			case "life_inv_trauben": {"trauben"};
		    case "life_inv_henrap": {"henrap"};
			case "life_inv_roosterrap": {"roosterrap"};
			case "life_inv_goatrap": {"goatrap"};
			case "life_inv_sheeprap": {"sheeprap"};
			case "life_inv_rabbitrap": {"rabbitrap"};
		    ...
		    case "life_inv_ring": {"ring"};
		    case "life_inv_seide": {"seide"};
		    case "life_inv_kunstoff": {"kunstoff"};
		    case "life_inv_reifenu": {"reifenu"};
			case "life_inv_reifenp": {"reifenp"};
		    case "life_inv_holzu": {"holzu"};
			case "life_inv_holzp": {"holzp"};
			case "life_inv_oilu": {"oilu"};
			case "life_inv_oilp": {"oilp"};
			case "life_inv_baumwolleu": {"baumwolleu"};
