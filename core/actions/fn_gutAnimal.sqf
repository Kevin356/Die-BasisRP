...
if(!((typeOf _animalCorpse) in ["Turtle_F","Hen_random_F","Cock_random_F","Goat_random_F","Sheep_random_F","Rabbit_F"])) exitWith {};
if(player distance _animalCorpse > 3.5) exitWith {};
life_action_inUse = true;
 switch(typeOf _animalCorpse) do {
    case "Turtle_F": {_displayName = "Schildkröte"; _itemName = "turtle"; _val = 1;};
    case "Hen_random_F": {_displayName = "Hühnchen"; _itemName = "henraw"; _val = 1;};
    case "Cock_random_F": {_displayName = "Hähnchen"; _itemName = "roosterraw"; _val = 1;};
    case "Goat_random_F": {_displayName = "Ziegen"; _itemName = "goatraw"; _val = 1;};
    case "Sheep_random_F": {_displayName = "Schaafs"; _itemName = "sheepraw"; _val = 1;};
    case "Rabbit_F": {_displayName = "Hasen"; _itemName = "rabbitraw"; _val = 1;};
    default {_displayName = ""; _itemName = ""; _val = 1;};
};
if (_displayName == "") exitWith {life_action_inUse = false;};
_upp = format["Verarbeite %1",_displayName];
