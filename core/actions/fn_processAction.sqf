...
_itemInfo = switch (_type) do
{
	...
	case "wein": {["trauben","wein",500,"Wein Herstellen"]};
    case "huhn": {["henraw","henrap",500,"Hähnchenfleisch Herstellen"]};
	case "hahn": {["roosterraw","roosterrap",500,"Hühnerfleisch Herstellen"]};
	case "ziege": {["goatraw","goatrap",500,"Ziegenfleisch Herstellen"]};
	case "schaaf": {["sheepraw","sheeprap",500,"Schaafsfleisch Herstellen"]};
	case "hasen": {["rabbitraw","rabbitrap",500,"Hasenfleisch Herstellen"]};
    case "reifen": {["reifenu","reifenp",500,"Gummi Herstellen"]};
    case "baumwolle": {["baumwolleu","baumwollep",500,"Baumwolle Verarbeiten"]};
	case "holz": {["holzu","holzp",350,"Holz Verarbeiten"]};
	...
	case "gold": {["goldu","goldp",400,"Golderz verarbeiten"]};
