[] spawn  {
	...
	_fnc_food = 
	{
		...
		switch(life_hunger) do {
			case 30: {hintSilent "Du Verspürst Huger,du solltest Langsam was essen!";};
			case 20: {hintSilent "Dir wird Langsam Schlecht vor Hunger du solltest was essen.";};
			case 10: {hintSilent "Du verhungerst nun Langsam,ess schnell was.";player setFatigue 1;};
			};
		};
	};
	...
	_fnc_water = 
	{
		...
		else
		{
			...
			{
				case 30: {hintSilent"Du solltest langsam was Trinken";};
				case 20: {hintSilent "Trink langsam was sonst verdurstest du."; player setFatigue 1;};
				case 10: {hintSilent "Du Bist am Dehydrieren,trink schnell was.!"; player setFatigue 1;};
			};
		};
	};
	...
	_fnc_battery =
	{
		...
		else
		{
			...
			{
				case 30: {hintSilent "Dein Akku hat noch 30%";};
				case 20: {hintSilent "Dein Akku hat noch 20%";};
				case 10: {hintSilent "Dein Akku hat noch 10%";};
			};
		};
	};
